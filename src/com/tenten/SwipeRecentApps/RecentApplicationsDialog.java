...
public class RecentApplicationsDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(getLayout("recentappdialog", "layout", "com.tenten.SwipeRecentApps"));
        ...
        taskman = (Button) findViewById(getLayout("taskman", "id", "com.tenten.SwipeRecentApps"));
        lin = (LinearLayout) findViewById(getLayout("swiperecent", "id", "com.tenten.SwipeRecentApps"));
        noApps = (TextView) findViewById(getLayout("noapps", "id", "com.tenten.SwipeRecentApps"));
        mainlayout = (RelativeLayout) findViewById(getLayout("mainlayout", "id", "com.tenten.SwipeRecentApps"));
        ...
        adapter = new AppsArrayAdapter(c, getLayout("appsview_item", "layout", "com.tenten.SwipeRecentApps"), appsList);
